...
export const DRINKS_DATA: DrinkItem[] = [
    {
        ...
        popular: true,
        sizes: [
            { size: 'small', price: 2.50, volume: '1 oz' },
            { size: 'medium', price: 3.00, volume: '2 oz' },
            { size: 'large', price: 3.50, volume: '3 oz' },
        ],
    },
    {
        id: '2',
        ...
        popular: true,
        sizes: [
            { size: 'small', price: 4.00, volume: '8 oz' },
            { size: 'medium', price: 4.50, volume: '12 oz' },
            { size: 'large', price: 5.00, volume: '16 oz' },
        ],
    },
    {
        id: '3',
        ...
        popular: false,
        sizes: [
            { size: 'small', price: 3.00, volume: '12 oz' },
            { size: 'medium', price: 3.50, volume: '16 oz' },
            { size: 'large', price: 4.00, volume: '20 oz' },
        ],
    },
    {
        id: '4',
        ...
        emoji: '☕',
        sizes: [
            { size: 'small', price: 3.50, volume: '6 oz' },
            { size: 'medium', price: 4.00, volume: '8 oz' },
            { size: 'large', price: 4.50, volume: '10 oz' },
        ],
    },
    {
        id: '5',
    ...
    },
    {
        ...
        popular: true,
        sizes: [
            { size: 'small', price: 4.50, volume: '12 oz' },
            { size: 'medium', price: 5.00, volume: '16 oz' },
            { size: 'large', price: 5.50, volume: '20 oz' },
        ],
    },
    {
        id: '8',
